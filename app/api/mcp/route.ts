...
const handler = createMcpHandler(
  (server) => {
    server.registerResource("nikechan-search-results", searchResultsAppUri, { mimeType: "text/html;profile=mcp-app", _meta: { "openai/widgetDescription": "AIニケちゃん検索結果をカードで表示します。", "openai/widgetPrefersBorder": true, "openai/widgetCSP": { connect_domains: ["https://ai-nikechan-mcp.vercel.app"], resource_domains: ["https://pbs.twimg.com", "https://nikechan.com"] } } }, async () => ({ contents: [{ uri: searchResultsAppUri, mimeType: "text/html;profile=mcp-app", text: searchResultsAppHtml }] }));
